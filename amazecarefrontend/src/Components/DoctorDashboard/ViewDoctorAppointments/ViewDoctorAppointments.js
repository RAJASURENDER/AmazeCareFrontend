                            ...
                            {filteredAppointments.length > 0 ? (
                                filteredAppointments.map(appointment => (
                                    <tr key={appointment.appointmentId}>
                                        ...
                                        <td> {appointment.status !== "Cancelled" && appointment.status !== "Completed" && (
                                            <div className="button-container">
                                                <Link className="btn btn-primary" to={`/doctorappointment/${doctorId}/generate-medical-record/${appointment.appointmentId}`}>Generate Medical Records</Link>
